...
import com.bwt.securechats.inputmethod.latin.common.UnicodeSurrogate;
import com.bwt.securechats.inputmethod.latin.settings.SpacingAndPunctuations;
import com.bwt.securechats.inputmethod.latin.utils.CapsModeUtils;
import com.bwt.securechats.inputmethod.latin.utils.DebugLogUtils;
  ...
  public void commitText(final CharSequence text, final int newCursorPosition) {
    ...
    if (isConnected()) {
      ...
      for (final CharacterStyle span : spans) {
        ...
        // See com.bwt.securechats.inputmethod.latin.common.Constants.UnicodeSurrogate
